...
export const ProjectsList: React.FC = () => {
  ...
  if (projects.length === 0) {
    return (
      <div style={{ maxWidth: 680, margin: '0 auto', padding: 40, textAlign: 'center' }}>
        <h2 style={{ fontSize: 24, marginBottom: 16, color: 'var(--text)' }}>No Projects Yet</h2>
        <p style={{ color: 'var(--text-muted)', marginBottom: 24 }}>
          Create a new project in the Setup tab to get started.
        </p>
      </div>
    );
  }
  ...
  return (
    <div style={{ maxWidth: 680, margin: '0 auto', padding: 24 }}>
      <h2 style={{ fontSize: 24, marginBottom: 24, color: 'var(--text)' }}>Projects</h2>
